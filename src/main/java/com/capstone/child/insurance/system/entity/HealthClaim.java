...
public class HealthClaim {
	...
	public HealthClaim( LocalDate incidenceDate, String hospitalName, String roomCategory,
			String reason, LocalDate admitDate, LocalDate dischargeDate, Double preHospitalExpenses,
			Double hospitalExpenses, Double postHospitalExpenses, Double ambulanceExpenses,
			com.capstone.child.insurance.system.entity.HealthClaim.healthApproval approval, Child child, Policy policy,
			byte[] hospitalBill, byte[] doctorPrescribtion, byte[] dischargeDocuments, byte[] ambulanceBill) {
		super();
