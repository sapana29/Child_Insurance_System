...
public class Parent {
	...
	public Parent( String firstName, String lastName, String adhaar, String address, String phone,
			String email, String password, String bankName, String accountNumber, String ifscCode
			) {
		super();
